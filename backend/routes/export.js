...
module.exports = function exportModule(config) {
  ...
  function handleExport(req, res) {
    ...
    const src = {
      ...
      send_device_id:  body.send_device_id  !== undefined ? body.send_device_id  : saved.send_device_id,
      send_device_id2: body.send_device_id2 !== undefined ? body.send_device_id2 : saved.send_device_id2,
    ...
    const backup = {
      ...
      profiles: [{
        profile: {
          ...
          device_id_seed:          '',
          send_device_id:          src.send_device_id  !== false,
          device_id2:              src.device_id2 || '',
          device_custom_dev_id2:   src.send_device_id2 !== false,
