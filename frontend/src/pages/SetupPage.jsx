...
export default function SetupPage() {
  ...
  async function handleEpgToggle(val) {
    ...
    try { await saveSettings({ epg_enabled: val }) } catch {}
  }
  async function handleAdultToggle(val) {
    setShowAdult(val)
    try { await saveSettings({ show_adult: val }) } catch {}
  }
